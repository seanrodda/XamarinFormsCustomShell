...
{
	public class MyShellItemRenderer : UITabBarController, IShellItemRenderer, IAppearanceObserver
	{
		...
		protected virtual void OnItemsCollectionChanged(object sender, NotifyCollectionChangedEventArgs e)
		{
			if (e.OldItems != null)
			{
				foreach (ShellSection shellSection in e.OldItems)
				{
					...
					if (renderer != null)
                    {
                        var controllers = ViewControllers.ToList();
                        controllers.Remove(renderer.ViewController);
